...
test({
	...
	dataProvider	: [
		...
		['testKey', '123', 'notNumeric', ['notNumeric']],
		['testKey', 'right', 'notNumeric', false],
		...
		['testKey', 'string', 'weakString', false],
		['testKey', 1, 'weakString', ['weakString']],
		['testKey', true, 'weakString', ['weakString']],
		['testKey', [], 'weakString', ['weakString']],
		['testKey', 1, 'weakNumeric', false],
		['testKey', '1', 'weakNumeric', ['weakNumeric']],
		['testKey', 'test', 'weakNumeric', ['weakNumeric']],
		['testKey', 'true', 'weakNumeric', ['weakNumeric']],
		['testKey', '', 'same', ['rules']],
		['testKey', '', 'different', ['rules']],
		['testKey', '', 'equals', ['rules']],
		['testKey', true, 'weakNumeric', ['weakNumeric']],
		['testKey', true, 'weakBoolean', false],
		['testKey', false, 'weakBoolean', false],
		['testKey', 'false', 'weakBoolean', ['weakBoolean']],
		['testKey', 'true', 'weakBoolean', ['weakBoolean']],
		['testKey', '0', 'weakBoolean', ['weakBoolean']],
		['testKey', '1', 'weakBoolean', ['weakBoolean']],
		['testKey', 1, 'weakBoolean', ['weakBoolean']],
		['testKey', 0, 'weakBoolean', ['weakBoolean']],
		['testKey', true, 'weakIsTrue', false],
		['testKey', 1, 'weakIsTrue', ['weakIsTrue']],
		['testKey', 'true', 'weakIsTrue', ['weakIsTrue']],
		['testKey', 'wrong', 'weakIsTrue', ['weakIsTrue']],
		['testKey', false, 'weakIsFalse', false],
		['testKey', 'false', 'weakIsFalse', ['weakIsFalse']],
