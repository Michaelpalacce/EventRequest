...
// });
// test({
// 	message	: 'Should just test2',
// 	test	: ( done ) => {
// 		done();
// 	}
// });
// test({
// 	message	: 'Should just test3',
// 	test	: ( done ) => {
// 		done();
// 	}
// });
// test({
// 	message	: 'Should just test4',
// 	test	: ( done ) => {
// 		done();
// 	}
// });
// test({
// 	message	: 'Should just test5',
// 	test	: ( done ) => {
// 		done();
// 	}
// });
// test({
// 	message	: 'Should just test6',
// 	test	: ( done ) => {
// 		done();
// 	}
// });
// test({
// 	message	: 'Should just test7',
// 	test	: ( done ) => {
// 		done( new Error( 'Failed :(' ) );
// 	}
// });
// test({
// 	message	: 'Should just test8',
// 	test	: ( done ) => {
// 		done();
// 	}
// });
